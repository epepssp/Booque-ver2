...
+ #### <div id="sec2">알림 생성</div>
  ...
  <div align="center"><img src="https://github.com/epepssp/Booque-ver2/assets/118948099/ca090a59-a4e5-47f5-bf17-c18ada6ceba1" height="400" alt="키워드알림"></div>
   ...
   ###### &nbsp;&nbsp; 1. 알림 받을 키워드 등록
   ###### &nbsp;&nbsp;&nbsp; 검색 결과 페이지에 사용자가 입력한 키워드가 포함된 도서를 최대 4권까지 추천해주는 방식으로 키워드 알림 등록을 유도한다.  
   ###### &nbsp;&nbsp;&nbsp; 사용자는 추천 리스트에서 원하는 항목을 클릭하여 알림 받을 키워드(bookId)로 등록 할 수 있다.
     ...
     ```html
        ...
        <div style="margin-bottom: 40px;">
           <h6 class="mb-1 fw-bold">&nbsp;이런 책 찾으시나요?</h6>
           <h6>&nbsp;원하는 책 클릭하고, 새 글 알림 받아보세요!</h6>
   ...
   ###### 2. 중고책 판매글 작성되는 시점에 알림 받기 등록된 전체 키워드 리스트에서 해당 도서와 일치하는 항목 있는지 확인하고,
   ###### 일치하는 항목이 있다면 키워드 알림 생성
 ...
 + #### <div id="sec3">알림 표시</div>
   ...
   ##### ◽ 로그인 사용자의 전체 알림을 drop-down 리스트로 보여줌
 ...
 + #### <div id="sec4">알림 확인 (= 알림 삭제)</div>
   ##### ◽ 알림 클릭 > 해당 댓글 또는 판매 글로 이동 > 알림 확인한 것으로 간주하고 알림 삭제
   ##### ◽ 새 댓글 알림 클릭해서 이동하면, 어떤 댓글이 새 댓글인지 백그라운드 컬러 효과로 표시 > 배경 클릭시 백그라운드 컬러 효과 사라짐
