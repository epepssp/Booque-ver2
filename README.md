...
+ #### <div id="sec2">알림 생성</div>
  ...
  ```javaScript
   ...
   <h5>1. 알림 받을 키워드 등록<br><br><small>&nbsp;&nbsp;&nbsp;당근마켓 기능 참고함 - 사용자가 검색한 검색어 기반으로 키워드 알림 등록하도록 유도</small><br><small>&nbsp;&nbsp;&nbsp;이런 중고책 찾으세요? 검색 결과 화면에 검색 키워드 포함된 도서 추천 리스트 제공 > 리스트에서 관심 있는 책 클릭해서 키워드 알림 받기 등록</small></h5>
