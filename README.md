...
+ #### <div id="sec2">알림 생성</div>
  ...
  ```javaScript
     ...
     ##### 2. 키워드 알림
     <h6>&nbsp;&nbsp;&nbsp;&nbsp;2-1. 알림 받을 키워드 등록<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;당근마켓 기능 참고함 - 사용자가 검색한 검색어 기반으로 키워드 알림 등록하도록 유도<br<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     검색 > 검색 결과 화면에 검색어(mainKeyword)가 포함된 도서 추천 리스트(4개) 보여줌 > 리스트에서 관심 있는 책 클릭해서 키워드 알림 받기 등록</h6>
