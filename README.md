...
## 나의 구현 기능
 ...
 + ##### [테이블 추가 / 도메인 컬럼 추가](#sec1)
 + ##### [알림 생성](#sec2)
   <h6>새 댓글 알림: 댓글 작성될 때</h6>
   <h6>키워드 알림: 알림 받을 키워드 등록 -> 중고장터 새 글 등록 시, 유저들이 등록한 키워드 리스트와 비교해서 일치하는 항목 있을 때 </h6>
     
   <span><small>일치하는 항목 있을 때 알림 생성</small></span><br>  
 ...
 + ##### [알림 표시](#sec3)
   + ##### 상단바에 알림 버튼 추가
   - 뱃지에 전체 알림 개수 표시
   - 로그인 한 사용자의 전체 알림 dropdown 리스트로 보여주기
 + ##### [알림 확인 (= 알림 삭제)](#sec4)
